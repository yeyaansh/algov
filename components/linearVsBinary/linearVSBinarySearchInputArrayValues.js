...
import LinearVsBinaryGame from "./linearVsBInaryGame";
let submitValue = [];
...
export default function LinearVsBinarySearchInputArrayValue() {
  ...
  return (
    <>
      ...
      <div className="bg-primary h-[100vh] pt-[30.8px] text-center">
        ...
        {opened && <LinearVsBinaryGame array={submitValue} target={targetValue} />}
      </div>
    </>
  );
}
